...
export const queryKeys = {
  ...
  lineItems: {
    ...
    additionalDetails: (id?: string) =>
      [...queryKeys.lineItems.details(), 'additionalDetails', id] as const,
    statuses: () => [...queryKeys.lineItems.all, 'statuses'] as const,
    history: (id: string) => [...queryKeys.lineItems.all, 'history', id] as const,
  },
  leads: {
    all: ['leads'] as const,
    ...
    totalCount: (lineItemId: string) => [...queryKeys.leads.all, 'totalCount', lineItemId] as const,
  ...
  deliverySchedules: {
    ...
    templateTypes: () => [...queryKeys.deliverySchedules.all, 'templateTypes'] as const,
    templateList: (type: string) =>
      [...queryKeys.deliverySchedules.all, 'templateList', type] as const,
  },
  pacing: {
    all: ['pacing'] as const,
    summary: (lineItemId: string) => [...queryKeys.pacing.all, 'summary', lineItemId] as const,
  ...
  roles: {
    ...
    list: (params: { page: number; size: number }) => [...queryKeys.roles.lists(), params] as const,
    byType: (type: string) => [...queryKeys.roles.all, 'byType', type] as const,
  ...
  organizations: {
    ...
    list: (params: Record<string, any>) => [...queryKeys.organizations.lists(), params] as const,
  ...
  integrations: {
    ...
    config: (id: string) => [...queryKeys.integrations.all, 'config', id] as const,
  ...
  templates: {
    ...
    dataMapperMetadata: () => [...queryKeys.templates.all, 'dataMapperMetadata'] as const,
  },
  deliveryFile: {
    all: ['deliveryFile'] as const,
    download: (token: string) => [...queryKeys.deliveryFile.all, 'download', token] as const,
  },
  analytics: {
  ...
  dzent: {
    ...
    organizations: (type: string) => [...queryKeys.dzent.all, 'organizations', type] as const,
