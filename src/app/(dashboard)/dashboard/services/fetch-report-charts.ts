import { BillingReportType, PerformanceReportType, ReachReportType } from '../lib/enums';
...
export async function fetchReportChartsData(
  ...
  const resource = ReportChartsResources[type as keyof typeof ReportChartsResources];
