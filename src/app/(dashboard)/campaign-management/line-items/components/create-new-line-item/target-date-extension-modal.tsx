...
export const TargetDateExtensionModal: React.FC<ITargetDateExtensionModalProps> = ({
  open,
  currentStartDate,
  currentDeliveryDate,
  newStartDate,
      ...
      <Space direction='vertical' size={0} className={styles.modalContent}>
        ...
        <Space className={styles.header} size='small'>
          <Flex align='center' gap='0.5rem'>
            ...
            <Text className={styles.headerTitle}>Target Start Date Extension</Text>
          </Flex>
        </Space>
        ...
        <Space direction='vertical' className={styles.body} size='large'>
          <Text className={styles.description}>
            The new Target Start Date is after the current Target Delivery Start Date. This requires
            updating the delivery date to maintain proper lead delivery scheduling.
          </Text>

          {/* Date Comparison */}
          <Flex justify='space-between' align='center' className={styles.dateComparison}>
              ...
              <Flex vertical gap='0.25rem'>
                <Flex align='center' gap='0.5rem'>
                  ...
                  <Text className={styles.dateText}>
                    <Space className={styles.dateTitle}>Start:</Space> {currentStartDate}
                  </Text>
                </Flex>
                <Flex align='center' gap='0.5rem'>
                  <CalendarOutlined className={styles.dateIcon} />
                  <Text className={styles.dateText}>
                    <Space className={styles.dateTitle}>Delivery:</Space> {currentDeliveryDate}
                  </Text>
                </Flex>
              </Flex>
            </Space>
            ...
            <Space direction='vertical' className={styles.dateBlock}>
              ...
              <Flex vertical gap='0.25rem'>
                <Flex align='center' gap='0.5rem'>
                  <CalendarOutlined className={styles.dateIcon} />
                  <Text className={styles.dateText}>
                    <Space className={styles.dateTitle}>Start:</Space> {newStartDate}
                  </Text>
                </Flex>
                <Flex align='center' gap='0.5rem'>
                  <CalendarOutlined className={styles.dateIcon} />
                  <Text className={styles.dateText}>
                    <Space className={styles.dateTitle}>Delivery:</Space> {suggestedDeliveryDate}
                  </Text>
                </Flex>
              </Flex>
            </Space>
          ...
          <Flex align='flex-start' gap='0.75rem' className={styles.note}>
            ...
            <Text className={styles.noteText}>
              The suggested Target Delivery Start Date is 7 days after the new Target Start Date.
            </Text>
          </Flex>
        </Space>
