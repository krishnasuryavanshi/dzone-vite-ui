...
export const ForgotPasswordSubtitle: FC<IForgotPasswordSubtitleProps> = ({ isLinkSent, email }) => {
  const style = {
  ...
  return (
    <Text style={style}>
      <Translate
        ...
        show={isLinkSent}
      />
      <Translate i18nKey='form.forgotPassword.messageResetPassword' show={!isLinkSent} />
    </Text>
  );
};
