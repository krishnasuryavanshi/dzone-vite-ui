...
export const JobTitleSelectAll: FC<JobTitleSelectAllProps> = ({ checked, onSelectAllChange }) => {
  const onSelectAll: CheckboxProps['onChange'] = () => {
    onSelectAllChange();
  };
  return (
    <Checkbox checked={checked} onChange={onSelectAll} style={{ marginLeft: '0.5rem' }}>
      <Text
        strong
        style={{
          fontSize: '0.875rem',
