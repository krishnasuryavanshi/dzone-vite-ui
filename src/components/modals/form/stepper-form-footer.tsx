...
import { ISaveAndCloseButtonProps, SaveAndCloseButton } from './save-and-close-button';
...
interface IStepperFormFooterProps
  extends ISubmitButtonProps, ICancelButtonProps, INextButtonProps, ISaveAndCloseButtonProps {
...
export const StepperFormFooter: FC<IStepperFormFooterProps> = ({
  ...
  return (
    ...
    >
      ...
      <SubmitButton show={isLastStep && showSaveAndClose !== false} onSubmit={onSubmit} />
      <SaveAndCloseButton
        show={!isLastStep && showSaveAndClose !== false}
        onSaveAndClose={onSaveAndClose}
      />
      <NextButton show={!isLastStep} onNext={onNext} />
    </Flex>
  );
};
